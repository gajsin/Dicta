...
<div class="settings-layout-root">
  <!-- Desktop collapsible sidebar: 190px open / 44px collapsed -->
...
<style>
  ...
  /* Keep the original 180ms motion while resizing only one layout property. */
  .settings-sidebar {
  ...
  .settings-detail-scroll {
    ...
    overflow-y: auto;
    box-sizing: border-box;
    padding: var(--content-top) 35px 24px 24px;
  }
</style>
